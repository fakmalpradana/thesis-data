...
CATALOG_ROWS = [
    ...
    ("ne10m_provinces_west_java", "reference/naturalearth/ne10m_provinces_west_java.gpkg", "gpkg", "vector", True,
     "Natural Earth 10m admin-1 states/provinces (public domain), subset Banten/Jakarta/Jabar/Jateng/DIY/Lampung",
     "Konteks Jawa bagian barat untuk inset peta (fig 4.7)"),
